...
class Iso3166Country
{
    ...
    private $_more = [
        ...
        'PR' => ['name' => 'PUERTO RICO', 'code' => '1939'],
        'PS' => ['name' => 'PALESTINIAN TERRITORY, OCCUPIED', 'code' => '970'],
     ...
     * @return string|null
     */
    public function getNumericCode($isoCode, $default = null)
    {
        if (isset($this->_mapping[$isoCode])) {
            return $this->_mapping[$isoCode];
        }
     ...
     * @return string|null
     */
    public function getPhoneCode($isoCode, $default = null)
    {
        if (isset($this->_more[$isoCode])) {
            return '+' . $this->_more[$isoCode]['code'];
        }
